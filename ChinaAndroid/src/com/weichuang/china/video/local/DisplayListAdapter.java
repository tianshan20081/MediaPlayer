...
import com.weichuang.china.video.local.PlayListsActivity.PublicTools;
import com.weichuang.china.video.local.PlayListsActivity.VideoWorkItem;
...
public class DisplayListAdapter extends BaseAdapter {
    ...
    public DisplayListAdapter(Context context) {
        mDefaultDrawable = context.getResources().getDrawable(R.drawable.icon);
