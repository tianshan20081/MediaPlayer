        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    View dragger = item.findViewById(R.id.move_indicator);
                    Rect r = mTempRect;
...
//                        adjustScrollBounds(y);
                        ...
                        if (speed != 0) {
                            ...
                            if (ref == AdapterView.INVALID_POSITION) {
                                ...
                                ref = pointToPosition(0, mHeight / 2 + getDividerHeight() + 100);
                            }
...
//        v.setBackgroundColor(backGroundColor);
    ...
    private void dragView(int x, int y) {
        ...
        if ( y - mDragPoint <= 0 ) {
        	caly = 0;
        } else if ( y + mItemHeightNormal - mDragPoint >= mHeight ) {
        	caly = mHeight - mItemHeightNormal;
        } else {
        	caly = y - mDragPoint;
        }
        mWindowParams.y = caly + mCoordOffset;
//        mWindowParams.y = y - mDragPoint + mCoordOffset;
